...
exports.GenesisState = exports.Sudoers = void 0;
/* eslint-disable */
...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return { sudoers: isSet(object.sudoers) ? exports.Sudoers.fromJSON(object.sudoers) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.sudoers !== undefined && (obj.sudoers = message.sudoers ? exports.Sudoers.toJSON(message.sudoers) : undefined);
        return obj;
    },
    create(base) {
