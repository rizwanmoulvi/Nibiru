...
exports.EventEpochEnd = exports.EventEpochStart = void 0;
/* eslint-disable */
...
exports.EventEpochStart = {
    ...
    fromJSON(object) {
        return {
            epochNumber: isSet(object.epochNumber) ? long_1.default.fromValue(object.epochNumber) : long_1.default.UZERO,
...
exports.EventEpochEnd = {
    ...
    fromJSON(object) {
        return { epochNumber: isSet(object.epochNumber) ? long_1.default.fromValue(object.epochNumber) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
        message.epochNumber !== undefined && (obj.epochNumber = (message.epochNumber || long_1.default.UZERO).toString());
