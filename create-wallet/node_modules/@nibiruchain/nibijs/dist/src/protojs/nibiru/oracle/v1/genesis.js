...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            pairs: Array.isArray(object === null || object === void 0 ? void 0 : object.pairs)
                ...
                : [],
            rewards: Array.isArray(object === null || object === void 0 ? void 0 : object.rewards) ? object.rewards.map((e) => oracle_1.Rewards.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.params = (object.params !== undefined && object.params !== null)
            ...
            : undefined;
        message.feederDelegations = ((_a = object.feederDelegations) === null || _a === void 0 ? void 0 : _a.map((e) => exports.FeederDelegation.fromPartial(e))) || [];
        message.exchangeRates = ((_b = object.exchangeRates) === null || _b === void 0 ? void 0 : _b.map((e) => oracle_1.ExchangeRateTuple.fromPartial(e))) || [];
        message.missCounters = ((_c = object.missCounters) === null || _c === void 0 ? void 0 : _c.map((e) => exports.MissCounter.fromPartial(e))) || [];
...
exports.MissCounter = {
    ...
    fromJSON(object) {
        return {
            validatorAddress: isSet(object.validatorAddress) ? String(object.validatorAddress) : "",
            missCounter: isSet(object.missCounter) ? long_1.default.fromValue(object.missCounter) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
