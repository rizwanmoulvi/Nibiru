...
exports.QueryClientImpl = exports.QueryServiceName = exports.QueryCurrentEpochResponse = exports.QueryCurrentEpochRequest = exports.QueryEpochInfosResponse = exports.QueryEpochInfosRequest = void 0;
/* eslint-disable */
...
exports.QueryEpochInfosRequest = {
    ...
    create(base) {
        return exports.QueryEpochInfosRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseQueryEpochInfosRequest();
        return message;
...
exports.QueryEpochInfosResponse = {
    ...
    fromJSON(object) {
        return { epochs: Array.isArray(object === null || object === void 0 ? void 0 : object.epochs) ? object.epochs.map((e) => state_1.EpochInfo.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.epochs) {
    ...
    create(base) {
        return exports.QueryEpochInfosResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryEpochInfosResponse();
...
exports.QueryCurrentEpochResponse = {
    ...
    fromJSON(object) {
        return { currentEpoch: isSet(object.currentEpoch) ? long_1.default.fromValue(object.currentEpoch) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
...
class QueryClientImpl {
    ...
    EpochInfos(request) {
        const data = exports.QueryEpochInfosRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "EpochInfos", data);
        return promise.then((data) => exports.QueryEpochInfosResponse.decode(minimal_1.default.Reader.create(data)));
    }
