...
exports.QueryPeriodResponse = {
    ...
    fromJSON(object) {
        return { period: isSet(object.period) ? long_1.default.fromValue(object.period) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryEpochMintProvisionResponse = {
    ...
    fromJSON(object) {
        return {
            epochMintProvision: isSet(object.epochMintProvision) ? coin_1.DecCoin.fromJSON(object.epochMintProvision) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        message.epochMintProvision !== undefined &&
            (obj.epochMintProvision = message.epochMintProvision ? coin_1.DecCoin.toJSON(message.epochMintProvision) : undefined);
        return obj;
    },
    create(base) {
...
exports.QuerySkippedEpochsResponse = {
    ...
    fromJSON(object) {
        return { skippedEpochs: isSet(object.skippedEpochs) ? long_1.default.fromValue(object.skippedEpochs) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
        message.skippedEpochs !== undefined && (obj.skippedEpochs = (message.skippedEpochs || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
...
exports.QueryCirculatingSupplyResponse = {
    ...
    fromJSON(object) {
        return {
            circulatingSupply: isSet(object.circulatingSupply) ? coin_1.DecCoin.fromJSON(object.circulatingSupply) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        message.circulatingSupply !== undefined &&
            (obj.circulatingSupply = message.circulatingSupply ? coin_1.DecCoin.toJSON(message.circulatingSupply) : undefined);
        return obj;
    },
    create(base) {
