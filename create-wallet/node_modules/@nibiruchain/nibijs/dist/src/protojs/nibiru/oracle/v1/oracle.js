...
exports.Rewards = exports.DatedPrice = exports.ExchangeRateTuple = exports.AggregateExchangeRateVote = exports.AggregateExchangeRatePrevote = exports.Params = void 0;
/* eslint-disable */
...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            ...
            slashWindow: isSet(object.slashWindow) ? long_1.default.fromValue(object.slashWindow) : long_1.default.UZERO,
            minValidPerWindow: isSet(object.minValidPerWindow) ? String(object.minValidPerWindow) : "",
            twapLookbackWindow: isSet(object.twapLookbackWindow) ? duration_1.Duration.fromJSON(object.twapLookbackWindow) : undefined,
            minVoters: isSet(object.minVoters) ? long_1.default.fromValue(object.minVoters) : long_1.default.UZERO,
            validatorFeeRatio: isSet(object.validatorFeeRatio) ? String(object.validatorFeeRatio) : "",
            expirationBlocks: isSet(object.expirationBlocks) ? long_1.default.fromValue(object.expirationBlocks) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.twapLookbackWindow !== undefined &&
            (obj.twapLookbackWindow = message.twapLookbackWindow ? duration_1.Duration.toJSON(message.twapLookbackWindow) : undefined);
        message.minVoters !== undefined && (obj.minVoters = (message.minVoters || long_1.default.UZERO).toString());
...
exports.AggregateExchangeRatePrevote = {
    ...
    fromJSON(object) {
        return {
            ...
            submitBlock: isSet(object.submitBlock) ? long_1.default.fromValue(object.submitBlock) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.AggregateExchangeRateVote = {
    ...
    fromPartial(object) {
        var _a, _b;
        const message = createBaseAggregateExchangeRateVote();
        message.exchangeRateTuples = ((_a = object.exchangeRateTuples) === null || _a === void 0 ? void 0 : _a.map((e) => exports.ExchangeRateTuple.fromPartial(e))) || [];
        message.voter = (_b = object.voter) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
...
exports.DatedPrice = {
    ...
    fromJSON(object) {
        return {
            exchangeRate: isSet(object.exchangeRate) ? String(object.exchangeRate) : "",
            createdBlock: isSet(object.createdBlock) ? long_1.default.fromValue(object.createdBlock) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        message.exchangeRate !== undefined && (obj.exchangeRate = message.exchangeRate);
        message.createdBlock !== undefined && (obj.createdBlock = (message.createdBlock || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
...
exports.Rewards = {
    ...
    fromJSON(object) {
        return {
            ...
            votePeriods: isSet(object.votePeriods) ? long_1.default.fromValue(object.votePeriods) : long_1.default.UZERO,
    ...
    toJSON(message) {
        ...
        message.votePeriods !== undefined && (obj.votePeriods = (message.votePeriods || long_1.default.UZERO).toString());
        if (message.coins) {
