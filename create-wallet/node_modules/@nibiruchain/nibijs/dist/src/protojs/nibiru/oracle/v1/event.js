...
exports.EventValidatorPerformance = exports.EventAggregatePrevote = exports.EventAggregateVote = exports.EventDelegateFeederConsent = exports.EventPriceUpdate = void 0;
/* eslint-disable */
...
exports.EventPriceUpdate = {
    ...
    fromJSON(object) {
        return {
            ...
            timestampMs: isSet(object.timestampMs) ? long_1.default.fromValue(object.timestampMs) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.timestampMs !== undefined && (obj.timestampMs = (message.timestampMs || long_1.default.ZERO).toString());
        return obj;
    },
    create(base) {
...
exports.EventAggregateVote = {
    ...
    fromJSON(object) {
        return {
            validator: isSet(object.validator) ? String(object.validator) : "",
            feeder: isSet(object.feeder) ? String(object.feeder) : "",
            prices: Array.isArray(object === null || object === void 0 ? void 0 : object.prices) ? object.prices.map((e) => oracle_1.ExchangeRateTuple.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.validator = (_a = object.validator) !== null && _a !== void 0 ? _a : "";
        message.feeder = (_b = object.feeder) !== null && _b !== void 0 ? _b : "";
        message.prices = ((_c = object.prices) === null || _c === void 0 ? void 0 : _c.map((e) => oracle_1.ExchangeRateTuple.fromPartial(e))) || [];
        return message;
    },
};
...
function createBaseEventValidatorPerformance() {
    return {
        validator: "",
        votingPower: long_1.default.ZERO,
        rewardWeight: long_1.default.ZERO,
        winCount: long_1.default.ZERO,
        abstainCount: long_1.default.ZERO,
        missCount: long_1.default.ZERO,
    };
}
exports.EventValidatorPerformance = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.validator !== "") {
            writer.uint32(10).string(message.validator);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.rewardWeight = reader.int64();
                    continue;
                case 4:
                    if (tag !== 32) {
                        break;
                    }
                    message.winCount = reader.int64();
                    continue;
                case 5:
                    if (tag !== 40) {
                        break;
                    }
                    message.abstainCount = reader.int64();
                    continue;
                case 6:
                    if (tag !== 48) {
                        break;
                    }
                    message.missCount = reader.int64();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            rewardWeight: isSet(object.rewardWeight) ? long_1.default.fromValue(object.rewardWeight) : long_1.default.ZERO,
            winCount: isSet(object.winCount) ? long_1.default.fromValue(object.winCount) : long_1.default.ZERO,
            abstainCount: isSet(object.abstainCount) ? long_1.default.fromValue(object.abstainCount) : long_1.default.ZERO,
            missCount: isSet(object.missCount) ? long_1.default.fromValue(object.missCount) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.rewardWeight !== undefined && (obj.rewardWeight = (message.rewardWeight || long_1.default.ZERO).toString());
        message.winCount !== undefined && (obj.winCount = (message.winCount || long_1.default.ZERO).toString());
        message.abstainCount !== undefined && (obj.abstainCount = (message.abstainCount || long_1.default.ZERO).toString());
        message.missCount !== undefined && (obj.missCount = (message.missCount || long_1.default.ZERO).toString());
        return obj;
    },
    create(base) {
        return exports.EventValidatorPerformance.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseEventValidatorPerformance();
