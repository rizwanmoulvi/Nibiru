...
exports.Signer = exports.newRandomWallet = exports.DirectSecp256k1HdWallet = exports.newSignerFromMnemonic = exports.getRegistry = exports.BECH32_PREFIX = void 0;
...
const getRegistry = () => new proto_signing_1.Registry(stargate_1.defaultRegistryTypes);
 ...
 */
const newSignerFromMnemonic = (mnemonic, prefix = BECH32_PREFIX.ADDR) => __awaiter(void 0, void 0, void 0, function* () { return proto_signing_1.DirectSecp256k1HdWallet.fromMnemonic(mnemonic, { prefix }); });
 ...
 * @returns A wallet for protobuf based signing using SIGN_MODE_DIRECT.
 */
const newRandomWallet = (length, prefix = BECH32_PREFIX.ADDR) => proto_signing_1.DirectSecp256k1HdWallet.generate(length !== null && length !== void 0 ? length : 24, { prefix });
