 ...
 */
export declare const newSignerFromMnemonic: (mnemonic: string, prefix?: BECH32_PREFIX) => Promise<DirectSecp256k1HdWallet>;
 ...
 * @returns A wallet for protobuf based signing using SIGN_MODE_DIRECT.
 */
export declare const newRandomWallet: (length?: 12 | 15 | 18 | 21 | 24, prefix?: BECH32_PREFIX) => Promise<DirectSecp256k1HdWallet>;
